...
@IBDesignable class SpeedDashboardView : DashboardView, UnitsView {
    ...
    var units : Units = .imperial {
        didSet {
            _speedUnitsLabel.text = Measure.speedLabel.lowercased()
        }
    }
    ...
    func commonInit() {
        ...
        _speedLabel.font = UIFont(name:fontName, size:heroFontSize)
        _speedLabel.translatesAutoresizingMaskIntoConstraints = false
        _speedLabel.adjustsFontSizeToFitWidth = true
        _speedLabel.text = "—.–"
        
        _speedUnitsLabel.font = UIFont(name:fontName, size:captionFontSize)
        ...
        maxSpeed.font = UIFont(name:fontName, size:minorFontSize)
        maxSpeed.translatesAutoresizingMaskIntoConstraints = false
        maxSpeed.adjustsFontSizeToFitWidth = false
        
        maxSpeedCaption.font = UIFont(name:fontName, size: captionFontSize)
        ...
        avgSpeed.font = UIFont(name:fontName, size:minorFontSize)
        avgSpeed.translatesAutoresizingMaskIntoConstraints = false
        avgSpeed.adjustsFontSizeToFitWidth = false
        avgSpeed.text = "—.–"
        
        avgSpeedCaption.font = UIFont(name:fontName, size: captionFontSize)
